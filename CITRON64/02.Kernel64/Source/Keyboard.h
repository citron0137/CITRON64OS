...
#define KEY_F10                 0x91
#define KEY_NUMLOCK             0x92
#define KEY_SCROLLLOCK          0x93
#define KEY_HOME                0x94
#define KEY_UP                  0x95
#define KEY_PAGEUP              0x96
#define KEY_LEFT                0x97
#define KEY_CENTER              0x98
...
typedef struct kKeyMappingEntiryStruct
{
    BYTE bNormalCode;
    BYTE bCombinedCode;
} KEYMAPPINGENTRY;
...
BYTE kConvertScanCodeToASCIICode(BYTE bScanCode, BYTE* pbASCIICode, BOOL * pbFlags);
